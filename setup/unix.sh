...
haxelib git lime https://github.com/HomuHomu833-haxe-stuff/lime --quiet
haxelib install openfl 9.4.1 --quiet
haxelib git flixel https://github.com/Prohack101010/flixel-5.8.0-fixed --quiet
...
haxelib git mobile-controls https://github.com/Prohack101010/mobile-controls-dev --quiet //credit :D https://github.com/Prohack101010
echo Finished!
